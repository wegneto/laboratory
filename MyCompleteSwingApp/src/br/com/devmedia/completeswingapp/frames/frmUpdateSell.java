...
public class frmUpdateSell extends javax.swing.JDialog {
    ...
    public frmUpdateSell(java.awt.Frame parent, boolean modal, SellDAO dao, frmSells parentFrame, Sell sell) {
        super(parent, modal);
        this.dao = dao;
    ...
    private void loadUpdateData() {
        txtDate.setText(new SimpleDateFormat("dd/mm/yyyy").format(sell.getDateOfSale()));
        itens = sell.getItems();
        cmbVendor.setSelectedItem(sell.getVendor());
    }
}
